...
public class QuarantiningUrlClassLoaderTest {
	...
	public void quarantinedClassIsLoadedByUs() throws Exception {
		...
		assertThat(quarantinedClass.getClassLoader(), equalTo(loader));
	}
	...
	public void settingStaticVarBeforeIsolatedLoad() throws Exception {
		...
		assertThat(instance.getClass(), not(equalTo(isolated)));
		assertThat(isolated.getDeclaredMethod("getReferencedMember").invoke(isolated.newInstance()), is("0"));
	}
}
